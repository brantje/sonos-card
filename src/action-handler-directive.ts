...
// TODO You need to replace all instances of "action-handler-sonos" with "action-handler-<your card name>"
customElements.define('action-handler-sonos', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-sonos')) {
    return body.querySelector('action-handler-sonos') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-sonos');
